...
epub:clean create_generated_folder
	cd src &&  pandoc -s necromunda.tex -o necro.epub --verbose --webtex --epub-metadata epub_config/metadata.xml --epub-cover-image epub_config/cover.jpg --toc --toc-depth=2 --epub-stylesheet epub_config/stylesheet.css
